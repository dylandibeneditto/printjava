...
public class Mesh {
	...
	// meshes will rotate and scale around the anchor point, and the position
	// describes where this anchor point is in 3d space
	public Point anchor = new Point(0, 0, 0);
	// the rotation of the mesh in radians or degrees, depending on the mode set in
	// the stl file
	...
	/**
	 * Stream triangles to a consumer without requiring the entire triangle list to
	 * be stored.
	 */
