...
public class Grid extends Mesh {
     ...
     * @param xDivisions the xDivisions value.
     * @param yDivisions the yDivisions value.
     * @param zDivisions the zDivisions value.
     */
    public Grid(Function<Point, Boolean> f, double width, double height, double depth, int xDivisions, int yDivisions,
            int zDivisions) {
        this.width = width;
        this.height = height;
        this.depth = depth;
        ...
        for (int x = 0; x < xDivisions; x++) {
            for (int y = 0; y < yDivisions; y++) {
                for (int z = 0; z < zDivisions; z++) {
                    ...
                    double progress = ((x * yDivisions * zDivisions) + (y * zDivisions) + z)
                            / (double) ((xDivisions - 1) * (yDivisions - 1) * (zDivisions - 1));
